...
force ace_advanced_fatigue_loadFactor = 1.5262;
force ace_advanced_fatigue_performanceFactor = 2.50538;
force ace_advanced_fatigue_recoveryFactor = 3.51719;
force ace_advanced_fatigue_swayFactor = 0.5;
force ace_advanced_fatigue_terrainGradientFactor = 1.5;

// ACE Ferramentas de Mapa
...
// ACE Limitador de dist̢ncia de viṣo
...
force ace_medical_bleedingCoefficient = 2;
...
force ace_medical_treatment_cprSuccessChance = 0.501076;
...
// ACE Preenchimento de Carregador
...
force ace_overheating_unJamFailChance = 0.0997515;
...
force ace_switchunits_switchToCivilian = true;
force ace_switchunits_switchToEast = true;
force ace_switchunits_switchToIndependent = true;
force ace_switchunits_switchToWest = true;
...
force acex_field_rations_hungerSatiated = 3.69339;
force acex_field_rations_terrainObjectActions = true;
force acex_field_rations_thirstQuenched = 3.69339;
